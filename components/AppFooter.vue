    ...
    <div class="footer">
        ...
        <footer>
            <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                ...
                <span class="ml-3 text-xl">CMXBlog</span>
                </a>
                <p class="text-sm text-green-300 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-green-200 sm:py-2 sm:mt-0 mt-4">© 2021 Explosion —
                <a href="https://github.com/DevSecOpsGit" class="text-green-200 ml-1" rel="author noopener noreferrer" target="_blank">@DevSecOps</a>
                </p>
                ...
                <a class="ml-3" href="https://github.com/DevSecOpsGit">
